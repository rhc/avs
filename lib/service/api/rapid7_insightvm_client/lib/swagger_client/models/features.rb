...
module SwaggerClient
  class Features
    ...
    def self.openapi_types
      {
        :'adaptive_security' => :'Object',
        :'agents' => :'Object',
        :'dynamic_discovery' => :'Object',
        :'early_access' => :'Object',
        :'engine_pool' => :'Object',
        :'insight_platform' => :'Object',
        :'mobile' => :'Object',
        :'multitenancy' => :'Object',
        :'policy_editor' => :'Object',
        :'policy_manager' => :'Object',
        :'remediation_analytics' => :'Object',
        :'reporting' => :'Object',
        :'scanning' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::Features` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::Features`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'adaptive_security')
        self.adaptive_security = attributes[:'adaptive_security']
      end
      ...
      if attributes.key?(:'dynamic_discovery')
        self.dynamic_discovery = attributes[:'dynamic_discovery']
      end
      ...
      if attributes.key?(:'engine_pool')
        self.engine_pool = attributes[:'engine_pool']
      end

      if attributes.key?(:'insight_platform')
        self.insight_platform = attributes[:'insight_platform']
      end
      ...
      if attributes.key?(:'multitenancy')
        self.multitenancy = attributes[:'multitenancy']
      end

      if attributes.key?(:'policy_editor')
        self.policy_editor = attributes[:'policy_editor']
      end

      if attributes.key?(:'policy_manager')
        self.policy_manager = attributes[:'policy_manager']
      end

      if attributes.key?(:'remediation_analytics')
        self.remediation_analytics = attributes[:'remediation_analytics']
      end
