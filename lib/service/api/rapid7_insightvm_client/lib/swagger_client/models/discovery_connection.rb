  ...
  class DiscoveryConnection
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::DiscoveryConnection` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::DiscoveryConnection`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'exchange_server_hostname')
        self.exchange_server_hostname = attributes[:'exchange_server_hostname']
      end

      if attributes.key?(:'exchange_user')
        self.exchange_user = attributes[:'exchange_user']
      end
      ...
      if attributes.key?(:'ldap_server')
        self.ldap_server = attributes[:'ldap_server']
      end
      ...
      if attributes.key?(:'scan_engine_is_inside_aws')
        self.scan_engine_is_inside_aws = attributes[:'scan_engine_is_inside_aws']
      end
      ...
      if attributes.key?(:'win_rm_server')
        self.win_rm_server = attributes[:'win_rm_server']
      end
    end
