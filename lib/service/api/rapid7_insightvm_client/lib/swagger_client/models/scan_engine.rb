...
module SwaggerClient
  class ScanEngine
    ...
    attr_accessor :is_aws_pre_auth_engine
    ...
    def self.attribute_map
      {
        ...
        :'id' => :'id',
        :'is_aws_pre_auth_engine' => :'isAWSPreAuthEngine',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::ScanEngine` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::ScanEngine`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'content_version')
      ...
      if attributes.key?(:'is_aws_pre_auth_engine')
        self.is_aws_pre_auth_engine = attributes[:'is_aws_pre_auth_engine']
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('Object', ['active', 'incompatible-version', 'not-responding', 'pending-authorization', 'unknown'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('Object', ['active', 'incompatible-version', 'not-responding', 'pending-authorization', 'unknown'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          is_aws_pre_auth_engine == o.is_aws_pre_auth_engine &&
    ...
    def hash
      [address, content_version, id, is_aws_pre_auth_engine, last_refreshed_date, last_updated_date, links, name, port, product_version, serial_number, sites, status].hash
    end
