...
module SwaggerClient
  class RiskTrendResource
    ...
    def self.openapi_types
      {
        :'all_assets' => :'Object',
        :'asset_group_membership' => :'Object',
        :'asset_groups' => :'Object',
        :'assets' => :'Object',
        :'from' => :'Object',
        :'sites' => :'Object',
        :'tag_membership' => :'Object',
        :'tags' => :'Object',
        :'to' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::RiskTrendResource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::RiskTrendResource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'all_assets')
        self.all_assets = attributes[:'all_assets']
      end

      if attributes.key?(:'asset_group_membership')
        self.asset_group_membership = attributes[:'asset_group_membership']
      end

      if attributes.key?(:'asset_groups')
        self.asset_groups = attributes[:'asset_groups']
      end
      ...
      if attributes.key?(:'tag_membership')
        self.tag_membership = attributes[:'tag_membership']
      end
    ...
    def valid?
      asset_group_membership_validator = EnumAttributeValidator.new('Object', ['historical', 'generation'])
      return false unless asset_group_membership_validator.valid?(@asset_group_membership)
      asset_groups_validator = EnumAttributeValidator.new('Object', ['average', 'total'])
      return false unless asset_groups_validator.valid?(@asset_groups)
      from_validator = EnumAttributeValidator.new('Object', ['P1Y', 'P6M', 'P3M', 'P1M', '<date>'])
      return false unless from_validator.valid?(@from)
      sites_validator = EnumAttributeValidator.new('Object', ['average', 'total'])
      return false unless sites_validator.valid?(@sites)
      tag_membership_validator = EnumAttributeValidator.new('Object', ['historical', 'generation'])
      return false unless tag_membership_validator.valid?(@tag_membership)
      tags_validator = EnumAttributeValidator.new('Object', ['average', 'total'])
    ...
    def asset_group_membership=(asset_group_membership)
      validator = EnumAttributeValidator.new('Object', ['historical', 'generation'])
    ...
    def asset_groups=(asset_groups)
      validator = EnumAttributeValidator.new('Object', ['average', 'total'])
    ...
    def from=(from)
      validator = EnumAttributeValidator.new('Object', ['P1Y', 'P6M', 'P3M', 'P1M', '<date>'])
