  ...
  class WebHeaderAuthentication
    ...
    def self.openapi_types
      {
        ...
        :'id' => :'Object',
        :'links' => :'Object',
        :'login_regular_expression' => :'Object',
        :'name' => :'Object',
        :'service' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::WebHeaderAuthentication` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::WebHeaderAuthentication`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'login_regular_expression')
        self.login_regular_expression = attributes[:'login_regular_expression']
      end
    ...
    def valid?
      service_validator = EnumAttributeValidator.new('Object', ['html-form', 'http-header'])
    ...
    def service=(service)
      validator = EnumAttributeValidator.new('Object', ['html-form', 'http-header'])
