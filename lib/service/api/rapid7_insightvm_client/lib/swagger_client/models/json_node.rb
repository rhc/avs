  ...
  class JsonNode
    ...
    def self.openapi_types
      {
        ...
        :'double' => :'Object',
        :'float' => :'Object',
        :'floating_point_number' => :'Object',
        :'int' => :'Object',
        :'integral_number' => :'Object',
        :'long' => :'Object',
        :'missing_node' => :'Object',
        :'node_type' => :'Object',
        :'null' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::JsonNode` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::JsonNode`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      node_type_validator = EnumAttributeValidator.new('Object', ['ARRAY', 'BINARY', 'BOOLEAN', 'MISSING', 'NULL', 'NUMBER', 'OBJECT', 'POJO', 'STRING'])
    ...
    def node_type=(node_type)
      validator = EnumAttributeValidator.new('Object', ['ARRAY', 'BINARY', 'BOOLEAN', 'MISSING', 'NULL', 'NUMBER', 'OBJECT', 'POJO', 'STRING'])
