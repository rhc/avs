  ...
  class AssetTag
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::AssetTag` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::AssetTag`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'risk_modifier')
        self.risk_modifier = attributes[:'risk_modifier']
      end

      if attributes.key?(:'search_criteria')
        self.search_criteria = attributes[:'search_criteria']
      end
    ...
    def valid?
      color_validator = EnumAttributeValidator.new('Object', ['default', 'blue', 'green', 'orange', 'red', 'purple'])
      return false unless color_validator.valid?(@color)
      return false if @name.nil?
      source_validator = EnumAttributeValidator.new('Object', ['built-in', 'custom'])
      return false unless source_validator.valid?(@source)
      return false if @type.nil?
      type_validator = EnumAttributeValidator.new('Object', ['custom', 'location', 'owner', 'criticality'])
    ...
    def color=(color)
      validator = EnumAttributeValidator.new('Object', ['default', 'blue', 'green', 'orange', 'red', 'purple'])
    ...
    def source=(source)
      validator = EnumAttributeValidator.new('Object', ['built-in', 'custom'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('Object', ['custom', 'location', 'owner', 'criticality'])
