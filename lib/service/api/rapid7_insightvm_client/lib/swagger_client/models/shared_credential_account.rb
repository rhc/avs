  ...
  class SharedCredentialAccount
    ...
    def self.openapi_types
      {
        ...
        :'database' => :'Object',
        :'domain' => :'Object',
        :'enumerate_sids' => :'Object',
        :'notes_id_password' => :'Object',
        :'ntlm_hash' => :'Object',
        :'oracle_listener_password' => :'Object',
        :'password' => :'Object',
        :'pem_key' => :'Object',
        :'permission_elevation' => :'Object',
        :'permission_elevation_password' => :'Object',
        :'permission_elevation_username' => :'Object',
        ...
        :'service_name' => :'Object',
        :'sid' => :'Object',
        :'use_windows_authentication' => :'Object',
        :'username' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::SharedCredentialAccount` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::SharedCredentialAccount`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'enumerate_sids')
        self.enumerate_sids = attributes[:'enumerate_sids']
      end

      if attributes.key?(:'notes_id_password')
        self.notes_id_password = attributes[:'notes_id_password']
      end

      if attributes.key?(:'ntlm_hash')
        self.ntlm_hash = attributes[:'ntlm_hash']
      end

      if attributes.key?(:'oracle_listener_password')
        self.oracle_listener_password = attributes[:'oracle_listener_password']
      end
      ...
      if attributes.key?(:'pem_key')
        self.pem_key = attributes[:'pem_key']
      end

      if attributes.key?(:'permission_elevation')
        self.permission_elevation = attributes[:'permission_elevation']
      end

      if attributes.key?(:'permission_elevation_password')
        self.permission_elevation_password = attributes[:'permission_elevation_password']
      end

      if attributes.key?(:'permission_elevation_username')
        self.permission_elevation_username = attributes[:'permission_elevation_username']
      end
