...
module SwaggerClient
  class OperatingSystemCpe
    ...
    # Defines the language supported in the user interface of the product being described. The format is of the language tag adheres to <a target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://tools.ietf.org/html/rfc5646\">RFC5646</a>.
    ...
    # The full CPE string in the <a target=\"_blank\" rel=\"noopener noreferrer\" href=\"https://cpe.mitre.org/files/cpe-specification_2.2.pdf\">CPE 2.2</a> format.
    attr_accessor :v2_2

    # The full CPE string in the <a target=\"_blank\" rel=\"noopener noreferrer\" href=\"http://nvlpubs.nist.gov/nistpubs/Legacy/IR/nistir7695.pdf\">CPE 2.3</a> format.
    attr_accessor :v2_3
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::OperatingSystemCpe` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::OperatingSystemCpe`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'v2_2')
        self.v2_2 = attributes[:'v2_2']
      end

      if attributes.key?(:'v2_3')
        self.v2_3 = attributes[:'v2_3']
      end
    ...
    def valid?
      ...
      part_validator = EnumAttributeValidator.new('Object', ['o', 'a', 'h'])
    ...
    def part=(part)
      validator = EnumAttributeValidator.new('Object', ['o', 'a', 'h'])
