  ...
  class ScanTemplate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::ScanTemplate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::ScanTemplate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'discovery_only')
        self.discovery_only = attributes[:'discovery_only']
      end

      if attributes.key?(:'enable_windows_services')
        self.enable_windows_services = attributes[:'enable_windows_services']
      end

      if attributes.key?(:'enhanced_logging')
        self.enhanced_logging = attributes[:'enhanced_logging']
      end
      ...
      if attributes.key?(:'max_parallel_assets')
        self.max_parallel_assets = attributes[:'max_parallel_assets']
      end

      if attributes.key?(:'max_scan_processes')
        self.max_scan_processes = attributes[:'max_scan_processes']
      end
      ...
      if attributes.key?(:'policy_enabled')
        self.policy_enabled = attributes[:'policy_enabled']
      end

      if attributes.key?(:'telnet')
        self.telnet = attributes[:'telnet']
      end

      if attributes.key?(:'vulnerability_enabled')
        self.vulnerability_enabled = attributes[:'vulnerability_enabled']
      end
