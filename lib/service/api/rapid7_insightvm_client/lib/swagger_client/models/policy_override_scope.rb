  ...
  class PolicyOverrideScope
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::PolicyOverrideScope` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::PolicyOverrideScope`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'new_result')
        self.new_result = attributes[:'new_result']
      end

      if attributes.key?(:'original_result')
        self.original_result = attributes[:'original_result']
      end
    ...
    def valid?
      ...
      new_result_validator = EnumAttributeValidator.new('Object', ['pass', 'fail', 'not-applicable', 'fixed'])
      return false unless new_result_validator.valid?(@new_result)
      original_result_validator = EnumAttributeValidator.new('Object', ['pass', 'fail', 'error', 'unknown', 'not-applicable', 'not-checked', 'not-selected', 'informational', 'fixed'])
    ...
    def new_result=(new_result)
      validator = EnumAttributeValidator.new('Object', ['pass', 'fail', 'not-applicable', 'fixed'])
    ...
    def original_result=(original_result)
      validator = EnumAttributeValidator.new('Object', ['pass', 'fail', 'error', 'unknown', 'not-applicable', 'not-checked', 'not-selected', 'informational', 'fixed'])
