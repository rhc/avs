  ...
  class Settings
    ...
    def self.openapi_types
      {
        ...
        :'insight_platform_region' => :'Object',
        :'links' => :'Object',
        :'risk' => :'Object',
        :'scan' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::Settings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::Settings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'asset_linking')
        self.asset_linking = attributes[:'asset_linking']
      end
      ...
      if attributes.key?(:'insight_platform_region')
        self.insight_platform_region = attributes[:'insight_platform_region']
      end
