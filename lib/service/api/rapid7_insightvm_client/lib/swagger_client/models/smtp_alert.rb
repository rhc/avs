...
module SwaggerClient
  class SmtpAlert
    ...
    def self.openapi_types
      {
        :'enabled' => :'Object',
        :'enabled_scan_events' => :'Object',
        :'enabled_vulnerability_events' => :'Object',
        :'id' => :'Object',
        :'limit_alert_text' => :'Object',
        :'links' => :'Object',
        :'maximum_alerts' => :'Object',
        :'name' => :'Object',
        :'notification' => :'Object',
        :'recipients' => :'Object',
        :'relay_server' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::SmtpAlert` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::SmtpAlert`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'enabled_scan_events')
        self.enabled_scan_events = attributes[:'enabled_scan_events']
      end

      if attributes.key?(:'enabled_vulnerability_events')
        self.enabled_vulnerability_events = attributes[:'enabled_vulnerability_events']
      end
      ...
      if attributes.key?(:'limit_alert_text')
        self.limit_alert_text = attributes[:'limit_alert_text']
      end
      ...
      if attributes.key?(:'maximum_alerts')
        self.maximum_alerts = attributes[:'maximum_alerts']
      end
      ...
      if attributes.key?(:'relay_server')
        self.relay_server = attributes[:'relay_server']
      end
    ...
    def valid?
      ...
      notification_validator = EnumAttributeValidator.new('Object', ['SMTP', 'SNMP', 'Syslog'])
    ...
    def notification=(notification)
      validator = EnumAttributeValidator.new('Object', ['SMTP', 'SNMP', 'Syslog'])
