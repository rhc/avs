  ...
  class Site
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::Site` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::Site`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'last_scan_time')
        self.last_scan_time = attributes[:'last_scan_time']
      end
      ...
      if attributes.key?(:'scan_engine')
        self.scan_engine = attributes[:'scan_engine']
      end

      if attributes.key?(:'scan_template')
        self.scan_template = attributes[:'scan_template']
      end
    ...
    def valid?
      connection_type_validator = EnumAttributeValidator.new('Object', ['activesync-ldap', 'activesync-office365', 'activesync-powershell', 'aws', 'dhcp', 'sonar', 'vsphere'])
      return false unless connection_type_validator.valid?(@connection_type)
      type_validator = EnumAttributeValidator.new('Object', ['agent', 'dynamic', 'static'])
    ...
    def connection_type=(connection_type)
      validator = EnumAttributeValidator.new('Object', ['activesync-ldap', 'activesync-office365', 'activesync-powershell', 'aws', 'dhcp', 'sonar', 'vsphere'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('Object', ['agent', 'dynamic', 'static'])
