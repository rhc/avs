...
module SwaggerClient
  class PolicyOverrideApi
    ...
    # @option opts [PolicyOverride] :body The specification of a policy override. Allows users to override the compliance result of a policy rule.
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [PolicyOverride] :body The specification of a policy override. Allows users to override the compliance result of a policy rule.
    # @return [Array<(CreatedReferencePolicyOverrideIDLink, Integer, Hash)>] CreatedReferencePolicyOverrideIDLink data, response status code and response headers
    ...
    # @param id The identifier of the asset.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ResourcesPolicyOverride, Integer, Hash)>] ResourcesPolicyOverride data, response status code and response headers
    ...
    # @param id The identifier of the policy override.
    # @param [Hash] opts the optional parameters
    # @return [Array<(PolicyOverride, Integer, Hash)>] PolicyOverride data, response status code and response headers
    ...
    # @option opts [Array<String>] :sort The criteria to sort the records by, in the format: &#x60;property[,ASC|DESC]&#x60;. The default sort order is ascending. Multiple sort criteria can be specified using multiple sort query parameters.
    # @return [Array<(PageOfPolicyOverride, Integer, Hash)>] PageOfPolicyOverride data, response status code and response headers
    ...
    # @param id The identifier of the policy override.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :body The date the policy override is set to expire. Date is represented in ISO 8601 format.
    # @return [Links]
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :body A comment describing the change of the policy override status.
    # @return [nil]
