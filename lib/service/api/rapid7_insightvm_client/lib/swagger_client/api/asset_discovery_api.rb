...
module SwaggerClient
  class AssetDiscoveryApi
    ...
    # @option opts [SonarQuery] :body The criteria for a Sonar query.
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [SonarQuery] :body The criteria for a Sonar query.
    # @return [Array<(CreatedReferenceDiscoveryQueryIDLink, Integer, Hash)>] CreatedReferenceDiscoveryQueryIDLink data, response status code and response headers
    def create_sonar_query_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'CreatedReferenceDiscoveryQueryIDLink' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [Links]
    def delete_sonar_query(site_idte_id, opts = {})
      data, _status_code, _headers = delete_sonar_query_with_http_info(site_idte_id, opts)
      data
    end
    ...
    def delete_sonar_query_with_http_info(site_idte_id, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/api/3/sonar_queries/{id}'.sub('{' + 'id' + '}', site_idte_id.to_s)
    ...
    def get_discovery_connection(site_idte_id, opts = {})
      data, _status_code, _headers = get_discovery_connection_with_http_info(site_idte_id, opts)
      data
    end
    ...
    # @param id The identifier of the discovery connection.
    # @param [Hash] opts the optional parameters
    # @return [Array<(DiscoveryConnection, Integer, Hash)>] DiscoveryConnection data, response status code and response headers
    def get_discovery_connection_with_http_info(site_idte_id, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/api/3/discovery_connections/{id}'.sub('{' + 'id' + '}', site_idte_id.to_s)
      ...
      return_type = opts[:return_type] || 'DiscoveryConnection' 
    ...
    # @option opts [Array<String>] :sort The criteria to sort the records by, in the format: &#x60;property[,ASC|DESC]&#x60;. The default sort order is ascending. Multiple sort criteria can be specified using multiple sort query parameters.
    # @return [Array<(PageOfDiscoveryConnection, Integer, Hash)>] PageOfDiscoveryConnection data, response status code and response headers
    def get_discovery_connections_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'PageOfDiscoveryConnection' 
    ...
    # Returns all sonar queries.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ResourcesSonarQuery, Integer, Hash)>] ResourcesSonarQuery data, response status code and response headers
    def get_sonar_queries_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ResourcesSonarQuery' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [SonarQuery]
    def get_sonar_query(site_idte_id, opts = {})
      data, _status_code, _headers = get_sonar_query_with_http_info(site_idte_id, opts)
      data
    end
    ...
    # @param id The identifier of the Sonar query.
    # @param [Hash] opts the optional parameters
    # @return [Array<(SonarQuery, Integer, Hash)>] SonarQuery data, response status code and response headers
    def get_sonar_query_with_http_info(site_idte_id, opts = {})
      if @api_client.config.debugging
      ...
      return_type = opts[:return_type] || 'SonarQuery' 
    ...
    def get_sonar_query_assets(site_idte_id, opts = {})
      data, _status_code, _headers = get_sonar_query_assets_with_http_info(site_idte_id, opts)
      data
    end
    ...
    # @param id The identifier of the Sonar query.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ResourcesDiscoveryAsset, Integer, Hash)>] ResourcesDiscoveryAsset data, response status code and response headers
    def get_sonar_query_assets_with_http_info(site_idte_id, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/api/3/sonar_queries/{id}/assets'.sub('{' + 'id' + '}', site_idte_id.to_s)
      ...
      return_type = opts[:return_type] || 'ResourcesDiscoveryAsset' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def reconnect_discovery_connection(site_idte_id, opts = {})
      reconnect_discovery_connection_with_http_info(site_idte_id, opts)
      nil
    end
    ...
    def reconnect_discovery_connection_with_http_info(site_idte_id, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/api/3/discovery_connections/{id}/connect'.sub('{' + 'id' + '}', site_idte_id.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [SonarCriteria] :body The criteria for a Sonar query.
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [SonarCriteria] :body The criteria for a Sonar query.
    # @return [Array<(Array<DiscoveryAsset>, Integer, Hash)>] Array<DiscoveryAsset> data, response status code and response headers
    def sonar_query_search_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'Array<DiscoveryAsset>' 
    ...
    # @option opts [SonarQuery] :body The criteria for a Sonar query.
    # @return [Links]
    def update_sonar_query(site_idte_id, opts = {})
      data, _status_code, _headers = update_sonar_query_with_http_info(site_idte_id, opts)
      data
    end
    ...
    # @option opts [SonarQuery] :body The criteria for a Sonar query.
    # @return [Array<(Links, Integer, Hash)>] Links data, response status code and response headers
    def update_sonar_query_with_http_info(site_idte_id, opts = {})
      if @api_client.config.debugging
