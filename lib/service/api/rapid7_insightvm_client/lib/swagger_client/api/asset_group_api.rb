...
module SwaggerClient
  class AssetGroupApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [AssetGroup] :body The details of the asset group.
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [AssetGroup] :body The details of the asset group.
    # @return [Array<(CreatedReferenceAssetGroupIDLink, Integer, Hash)>] CreatedReferenceAssetGroupIDLink data, response status code and response headers
    ...
    # @option opts [Array<String>] :sort The criteria to sort the records by, in the format: &#x60;property[,ASC|DESC]&#x60;. The default sort order is ascending. Multiple sort criteria can be specified using multiple sort query parameters.
    # @return [Array<(PageOfAgent, Integer, Hash)>] PageOfAgent data, response status code and response headers
    ...
    # @param id The identifier of the asset group.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ReferencesWithAssetIDLink, Integer, Hash)>] ReferencesWithAssetIDLink data, response status code and response headers
    ...
    # @param id The identifier of the asset group.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ReferencesWithTagIDLink, Integer, Hash)>] ReferencesWithTagIDLink data, response status code and response headers
    ...
    # @option opts [Integer] :size The number of records per page to retrieve.
    # @option opts [Array<String>] :sort The criteria to sort the records by, in the format: &#x60;property[,ASC|DESC]&#x60;. The default sort order is ascending. Multiple sort criteria can be specified using multiple sort query parameters.
    # @return [Array<(PageOfAssetGroup, Integer, Hash)>] PageOfAssetGroup data, response status code and response headers
    ...
    # @param id The identifier of the asset group.
    # @param [Hash] opts the optional parameters
    # @option opts [SearchCriteria] :body The search criteria specification.
    # @return [Links]
    ...
    # @param id The identifier of the asset group.
    # @param [Hash] opts the optional parameters
    # @option opts [Array<Integer>] :body The tags to associate to the asset group.
    # @return [Links]
    ...
    # @param id The identifier of the asset group.
    # @param [Hash] opts the optional parameters
    # @option opts [Array<Integer>] :body The users to grant access to the asset group.
    # @return [Links]
    ...
    # @param id The identifier of the asset group.
    # @param [Hash] opts the optional parameters
    # @option opts [Array<Integer>] :body The assets to place in the asset group. 
    # @return [Links]
