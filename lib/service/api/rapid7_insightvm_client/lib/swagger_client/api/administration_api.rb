...
module SwaggerClient
  class AdministrationApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :body The console command to execute.
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :body The console command to execute.
    # @return [Array<(ConsoleCommandOutput, Integer, Hash)>] ConsoleCommandOutput data, response status code and response headers
    def execute_command_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ConsoleCommandOutput' 
    ...
    def get_info_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'Info' 
    ...
    # Returns system details, including host and version information.
    # @param [Hash] opts the optional parameters
    # @return [Array<(EnvironmentProperties, Integer, Hash)>] EnvironmentProperties data, response status code and response headers
    def get_properties_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'EnvironmentProperties' 
