...
module SwaggerClient
  class ScanApi
    ...
    # @param id The identifier of the scan.
    # @param [Hash] opts the optional parameters
    # @return [Array<(Scan, Integer, Hash)>] Scan data, response status code and response headers
    ...
    # @option opts [Array<String>] :sort The criteria to sort the records by, in the format: &#x60;property[,ASC|DESC]&#x60;. The default sort order is ascending. Multiple sort criteria can be specified using multiple sort query parameters.
    # @return [Array<(PageOfGlobalScan, Integer, Hash)>] PageOfGlobalScan data, response status code and response headers
    ...
    # @param id The identifier of the site.
    # @param [Hash] opts the optional parameters
    # @option opts [AdhocScan] :body The details for the scan.
    # @option opts [BOOLEAN] :override_blackout Whether to request for the override of an scan blackout window. (default to false)
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [AdhocScan] :body The details for the scan.
    # @option opts [BOOLEAN] :override_blackout Whether to request for the override of an scan blackout window.
    # @return [Array<(CreatedReferenceScanIDLink, Integer, Hash)>] CreatedReferenceScanIDLink data, response status code and response headers
