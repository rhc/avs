...
module SwaggerClient
  class CredentialApi
    ...
    # @option opts [SharedCredential] :body The specification of a shared credential.
    ...
    # @param [Hash] opts the optional parameters
    # @return [Links]
    def delete_shared_credential(site_idte_id, opts = {})
      data, _status_code, _headers = delete_shared_credential_with_http_info(site_idte_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Links, Integer, Hash)>] Links data, response status code and response headers
    def delete_shared_credential_with_http_info(site_idte_id, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/api/3/shared_credentials/{id}'.sub('{' + 'id' + '}', site_idte_id.to_s)
    ...
    def get_shared_credential(site_idte_id, opts = {})
      data, _status_code, _headers = get_shared_credential_with_http_info(site_idte_id, opts)
      data
    end
    ...
    # @param id The identifier of the credential.
    # @param [Hash] opts the optional parameters
    # @return [Array<(SharedCredential, Integer, Hash)>] SharedCredential data, response status code and response headers
    def get_shared_credential_with_http_info(site_idte_id, opts = {})
      if @api_client.config.debugging
      ...
      return_type = opts[:return_type] || 'SharedCredential' 
    ...
    # Retrieves all defined shared credential resources.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ResourcesSharedCredential, Integer, Hash)>] ResourcesSharedCredential data, response status code and response headers
    def get_shared_credentials_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ResourcesSharedCredential' 
    ...
    # @param id The identifier of the credential.
    # @param [Hash] opts the optional parameters
    # @option opts [SharedCredential] :body The specification of the shared credential to update.
    # @return [Links]
    def update_shared_credential(site_idte_id, opts = {})
      data, _status_code, _headers = update_shared_credential_with_http_info(site_idte_id, opts)
      data
    end
    ...
    # @option opts [SharedCredential] :body The specification of the shared credential to update.
    # @return [Array<(Links, Integer, Hash)>] Links data, response status code and response headers
    def update_shared_credential_with_http_info(site_idte_id, opts = {})
      if @api_client.config.debugging
