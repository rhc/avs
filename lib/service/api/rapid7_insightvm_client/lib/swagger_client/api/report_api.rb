...
module SwaggerClient
  class ReportApi
    ...
    # @option opts [Report] :body The specification of a report configuration.
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Report] :body The specification of a report configuration.
    # @return [Array<(CreatedReferenceintLink, Integer, Hash)>] CreatedReferenceintLink data, response status code and response headers
    def create_report_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'CreatedReferenceintLink' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [Links]
    def delete_report(site_idte_id, opts = {})
      data, _status_code, _headers = delete_report_with_http_info(site_idte_id, opts)
      data
    end
    ...
    def delete_report_with_http_info(site_idte_id, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/api/3/reports/{id}'.sub('{' + 'id' + '}', site_idte_id.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [Links]
    def delete_report_instance(site_idte_id, instance, opts = {})
      data, _status_code, _headers = delete_report_instance_with_http_info(site_idte_id, instance, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Links, Integer, Hash)>] Links data, response status code and response headers
    def delete_report_instance_with_http_info(site_idte_id, instance, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/api/3/reports/{id}/history/{instance}'.sub('{' + 'id' + '}', site_idte_id.to_s).sub('{' + 'instance' + '}', instance.to_s)
    ...
    # @param [Hash] opts the optional parameters
    # @return [String]
    def download_report(site_idte_id, instance, opts = {})
      data, _status_code, _headers = download_report_with_http_info(site_idte_id, instance, opts)
      data
    end
    ...
    def download_report_with_http_info(site_idte_id, instance, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/api/3/reports/{id}/history/{instance}/output'.sub('{' + 'id' + '}', site_idte_id.to_s).sub('{' + 'instance' + '}', instance.to_s)
    ...
    def generate_report(site_idte_id, opts = {})
      data, _status_code, _headers = generate_report_with_http_info(site_idte_id, opts)
      data
    end
    ...
    # @param id The identifier of the report.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ReferenceWithReportIDLink, Integer, Hash)>] ReferenceWithReportIDLink data, response status code and response headers
    def generate_report_with_http_info(site_idte_id, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/api/3/reports/{id}/generate'.sub('{' + 'id' + '}', site_idte_id.to_s)
      ...
      return_type = opts[:return_type] || 'ReferenceWithReportIDLink' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [Report]
    def get_report(site_idte_id, opts = {})
      data, _status_code, _headers = get_report_with_http_info(site_idte_id, opts)
      data
    end
    ...
    def get_report_with_http_info(site_idte_id, opts = {})
      if @api_client.config.debugging
    ...
    # Returns all available report formats. A report format indicates an output file format specification (e.g. PDF, XML, etc). Some printable formats may be templated, and others may not. The supported templates for each formated are provided.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ResourcesAvailableReportFormat, Integer, Hash)>] ResourcesAvailableReportFormat data, response status code and response headers
    def get_report_formats_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ResourcesAvailableReportFormat' 
    ...
    def get_report_instance(site_idte_id, instance, opts = {})
      data, _status_code, _headers = get_report_instance_with_http_info(site_idte_id, instance, opts)
      data
    end
    ...
    # @param instance The identifier of the report instance.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ReportInstance, Integer, Hash)>] ReportInstance data, response status code and response headers
    def get_report_instance_with_http_info(site_idte_id, instance, opts = {})
      if @api_client.config.debugging
      ...
      return_type = opts[:return_type] || 'ReportInstance' 
    ...
    def get_report_instances(site_idte_id, opts = {})
      data, _status_code, _headers = get_report_instances_with_http_info(site_idte_id, opts)
      data
    end
    ...
    # @param id The identifier of the report.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ResourcesReportInstance, Integer, Hash)>] ResourcesReportInstance data, response status code and response headers
    def get_report_instances_with_http_info(site_idte_id, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/api/3/reports/{id}/history'.sub('{' + 'id' + '}', site_idte_id.to_s)
      ...
      return_type = opts[:return_type] || 'ResourcesReportInstance' 
    ...
    def get_report_template(site_idte_id, opts = {})
      data, _status_code, _headers = get_report_template_with_http_info(site_idte_id, opts)
      data
    end
    ...
    # @param id The identifier of the report template;
    # @param [Hash] opts the optional parameters
    # @return [Array<(ReportTemplate, Integer, Hash)>] ReportTemplate data, response status code and response headers
    def get_report_template_with_http_info(site_idte_id, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/api/3/report_templates/{id}'.sub('{' + 'id' + '}', site_idte_id.to_s)
      ...
      return_type = opts[:return_type] || 'ReportTemplate' 
    ...
    # Returns all available report templates.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ResourcesReportTemplate, Integer, Hash)>] ResourcesReportTemplate data, response status code and response headers
    def get_report_templates_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'ResourcesReportTemplate' 
    ...
    # @option opts [Array<String>] :sort The criteria to sort the records by, in the format: &#x60;property[,ASC|DESC]&#x60;. The default sort order is ascending. Multiple sort criteria can be specified using multiple sort query parameters.
    # @return [Array<(PageOfReport, Integer, Hash)>] PageOfReport data, response status code and response headers
    def get_reports_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'PageOfReport' 
    ...
    # @option opts [Report] :body The specification of a report configuration.
    # @return [Links]
    def update_report(site_idte_id, opts = {})
      data, _status_code, _headers = update_report_with_http_info(site_idte_id, opts)
      data
    end
    ...
    # @option opts [Report] :body The specification of a report configuration.
    # @return [Array<(Links, Integer, Hash)>] Links data, response status code and response headers
    def update_report_with_http_info(site_idte_id, opts = {})
      if @api_client.config.debugging
